            ...
            <div class="cont-header">
                <div class="popup-header bg-primary px-4 py-3 d-flex align-items-center">
                    <div class="profile-image">
                        <img src="{{asset('images/favicon.png')}}" alt="" class="img-fluid">
                    </div>
                    <div class="profile-info text-white">
                        <h5 class="m-0">Asistente Whatsapp</h5>
                        <h6 class="m-0 font-secondary">Escríbenos y te responderemos</h6>
                    </div>
                </div>
                <div class="popup-body p-3 pl-4 pt-2 position-relative">
                    ...
                    <div class="message-text hide whatsapp-message shadow-sm mb-2">
                        <h5 class="mb-2"><small class="text-muted font-secondary">Asistente Whatsapp</small></h5>
                        <p class="mb-1">
                            Bienvenido a esta pagina de Cursos de Especialización 👷
                        </p>
                        <p class="mb-1">
                    ...
                    <div class="message-text hide whatsapp-message shadow-sm mb-2">
                        ...
                        <p class="mb-1">
                            ¿Más información sobre las especializaciones? <a href="#" class="font-primary">AQUÍ</a>
                        </p>
                        <p class="mb-1">
